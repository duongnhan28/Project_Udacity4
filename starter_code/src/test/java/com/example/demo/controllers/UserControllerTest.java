...
public class UserControllerTest {
	...
	void findByUserNameNotFound() {
		...
		ResponseEntity<User> response = userController.findByUserName("nhandv7");
	...
	void createUser_passwordLengthThan7() {
		...
		request.setPassword("nhandv7Uda");
	...
	void createUserInvalidConfirmPassword() {
		...
		CreateUserRequest request = createUserRequest();
		request.setPassword("nhandv7Uda");
		request.setConfirmPassword("nhandv7UdaWrong");
		ResponseEntity<User> response = userController.createUser(request);
		assertEquals(HttpStatus.BAD_REQUEST, response.getStatusCode());
	}
	...
	void createUserSuccess() {
		...
		CreateUserRequest request = createUserRequest();
		request.setPassword("nhandv7Uda");
		request.setConfirmPassword("nhandv7Uda");
		ResponseEntity<User> response = userController.createUser(request);
		assertEquals(HttpStatus.OK, response.getStatusCode());
	}
	...
	private CreateUserRequest createUserRequest() {
		...
		request.setUsername("nhandv7Uda");
		return request;
	}
}
